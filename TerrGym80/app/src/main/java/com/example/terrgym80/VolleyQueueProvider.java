...
//            Log.e("LazyHolder.requestQueue: ", LazyHolder.requestQueue.toString());
    ...
    public static void callbackVolley(@NonNull final com.example.terrgym80.VolleyCallback volleyCallBack, String path, final Map<String, String> pMap) {
        Object result;
        final String url = "http://192.168.56.1:7000/" + path;
